...
description: |
  ...
  Rebase a worktree's feature branch back to the root repository's current branch. Supports calling from within a worktree (auto-detects branch) or from root (lists worktrees for selection).
when_to_use: |
